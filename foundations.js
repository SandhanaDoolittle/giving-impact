...
function renderSummary() {
  ...
  el.innerHTML =
    ...
    '<div class="fv-stats">' +
      ...
      '<div class="fv-stat"><div class="fv-stat-value" style="color:#ffffff">' + nc.toLocaleString() + '</div><div class="fv-stat-label">below legal 5% minimum</div></div>' +
      '<div class="fv-stat"><div class="fv-stat-value" style="color:#ffffff">' + fmtA(shortfall) + '</div><div class="fv-stat-label">undistributed vs legal minimum</div></div>' +
